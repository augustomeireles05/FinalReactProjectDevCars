...
function CheckoutOrder(props) {
  ...
  */
    ...
    //FIM: GERAR NUMERO RANDOMICO
     ...
     //INÍCIO: RECUPERAÇÃO DO ID DE ENDEREÇO E CARTÃO
     const addAdress = (event) => {
      setIdAdress(event.target.value)
      console.log("id do Endereço:", idAdress)
    }
    ...
    //FIM: RECUPERAÇÃO DO ID DE ENDEREÇO E CARTÃO
                ...
                <div className="modal-content background-modal-checkoutorder">
                  ...
                  <div className="modal-body">
                    <div className="container">
                      ...
                      <div className="col-12 col-sm-12 col-md-12 text-center mx-0 m-4">
                        <button className="col-12 col-md-4 btn-modal-checkoutorder pt-2 pb-2 pe-3 ps-3"
                          onClick={addCartao}>
                          Salvar
                        </button>
                      </div>
